...
(function (AGame) {
    ...
    __reflect(CCSkinCache.prototype, "CCSkinCache");
    var CCTheme = (function (_super) {
        __extends(CCTheme, _super);
        function CCTheme(configURL, stage, onThemeLoadComplete, target, isDelayed) {
            var _this = this;
            if (!isDelayed) {
                _this = _super.call(this, configURL, stage) || this;
            }
            else {
        ...
        CCTheme.prototype.onThemeLoaded = function (str) {
            ...
            if (str) {
                if (GameConst.DEBUG) {
                    try {
                        ...
                        egret.$error(3000, "on Theme parse error", str);
                    }
                }
                else {
                    var data = JSON.parse(str);
            ...
            else if (GameConst.DEBUG) {
                egret.$error(3000, "on Theme parse error", this.$url, str);
            }
    ...
    __reflect(CCTheme.prototype, "CCTheme");
    var ThemeUtils = (function () {
        ...
        ThemeUtils.setSkinFunc = function (comp, value) {
            // if (!AppConf.DEBUG) value = CCSkinCache.getTheme(value);
    ...
    __reflect(ThemeUtils.prototype, "AGame.ThemeUtils");
})(AGame || (AGame = {}));
