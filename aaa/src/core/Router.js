...
(function (AGame) {
    ...
    __reflect(HandlerObserver.prototype, "AGame.HandlerObserver", ["AGame.IHandlerObserver"]);
    var Router = (function () {
        function Router() {
    ...
    AGame.Router = Router;
    __reflect(Router.prototype, "AGame.Router", ["AGame.IRouter"]);
})(AGame || (AGame = {}));
